...
class UpdateParticipantRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'username' => 'required|string|min:3|max:50|unique:participants,username,' . $participantId . '|regex:/^[a-zA-Z0-9_]+$/',
    ...
    public function messages(): array
    {
        return [
            ...
            'email.unique'      => 'Email ini sudah digunakan oleh peserta lain.',
